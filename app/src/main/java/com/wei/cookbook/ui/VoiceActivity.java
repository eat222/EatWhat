...
public class VoiceActivity extends BaseActivity implements View.OnClickListener {
    ...
    private Button btn_startspeech, btn_startspeektext ,startcaipu , nextstep;
    private String a = "油锅烧至六成熟倒入玉米油，大火煸炒五花肉和大蒜。";
    private String b = "倒入扁豆，大火煸炒至软。";
    private String c = "加入少许盐。";
    private String d = "少许辣椒粉，加入少许水，不需要盖锅盖，直接烧一会大火收汁。";
    private String e;
    private int now = 1;
    private String res = "炸五花肉炒扁豆";
...
//                break;
    ...
    private void speekcaipu() {
        ...
        mTts.startSpeaking( res, new MySynthesizerListener()) ;
    }
...
//设置发音人（更多在线发音人，用户可参见 附录 13.2
        mTts.setParameter(SpeechConstant. VOICE_NAME, "xiaoyan" ); // 设置发音人F
        mTts.setParameter(SpeechConstant. SPEED, "45" );// 设置语速
        mTts.setParameter(SpeechConstant. VOLUME, "80" );// 设置音量，范围 0~100
        mTts.setParameter(SpeechConstant. ENGINE_TYPE, SpeechConstant. TYPE_CLOUD); //设置云端
